...
radius_a = [i for i in range(10, 100, 10)]

print(f'{"Method":<10}{"Time/s":>10}'
      f'{"min/m":>10}{"max/m":>10}{"mean/m":>10}'
...
for radius in radius_a:
    ...
    subprocess.run(['python3', 'accuracy.py',
                    'source.txt', 'f1.txt', 'f2.txt', 'f3.txt'],
                   stdout=subprocess.DEVNULL)
    with open('tmpfile1.txt', 'r') as f1, \
        ...
        for line1, line2 in zip(f1, f2):
            ...
            print(f'{sline1[0]:<10}{sline1[1]:>10}'
                  f'{sline2[1]:>10}{sline2[2]:>10}{sline2[3]:>10}'
                  f'{sline2[4]:>10.6}{sline2[5]:>10}')
